...
PotMet_Umbigo_All_Speed_Mean_withSpeedColumn = Data_Array_PotMet_Mean_Umbigo[:,0:2]
    ...
    #XIFOIDE
File_Path_PotMet_Mean_Xifoide = os.path.join("C:/Users/andre/Documents/Mestrado/Projetos Pesquisa/Projeto Marcha Água/Coletas/Data/Planilhas Gráficos Python/Mean_from_Statistics/Pot_Met_NET_Mean_Xifoide.txt")
...
Depth_Joelho_Meters = Data_Array_Profundidade_Meters[0,1]
Depth_Quadril_Meters = Data_Array_Profundidade_Meters[1,1]
Depth_Umbigo_Meters = Data_Array_Profundidade_Meters[2,1]
Depth_Xifoide_Meters = Data_Array_Profundidade_Meters[3,1]
...
Drag_F_per_Meter_Umbigo_SpeedEight_Mean = Data_Array_Drag_F_per_Meter_Umbigo[3,1]
    ...
    #XIFOIDE
File_Path_Drag_F_per_Meter_Xifoide = os.path.join("C:/Users/andre/Documents/Mestrado/Projetos Pesquisa/Projeto Marcha Água/Coletas/Data/Planilhas Gráficos Python/Mean_from_Statistics/Drag_F_Stride_per_Meter_Mean_Xifoide.txt")
...
GRF_V_Peak_Umbigo_SpeedEight_Mean = Data_Array_GRF_V_Peak_Umbigo[3,1]
    ...
    #XIFOIDE
File_Path_GRF_V_Peak_Xifoide = os.path.join("C:/Users/andre/Documents/Mestrado/Projetos Pesquisa/Projeto Marcha Água/Coletas/Data/Planilhas Gráficos Python/Mean_from_Statistics/GRF_V_Peak_Xifoide.txt")
...
CI_Two = [Custo_Joelho_SpeedTwo_CI, Custo_Quadril_SpeedTwo_CI, Custo_Umbigo_SpeedTwo_CI, Custo_Xifoide_SpeedTwo_CI]
CI_Four = [Custo_Joelho_SpeedFour_CI, Custo_Quadril_SpeedFour_CI, Custo_Umbigo_SpeedFour_CI, Custo_Xifoide_SpeedFour_CI]
CI_Six = [Custo_Joelho_SpeedSix_CI, Custo_Quadril_SpeedSix_CI, Custo_Umbigo_SpeedSix_CI, Custo_Xifoide_SpeedSix_CI]
CI_Eight = [Custo_Joelho_SpeedEight_CI, Custo_Quadril_SpeedEight_CI, Custo_Umbigo_SpeedEight_CI, Custo_Xifoide_SpeedEight_CI]
...
ax.errorbar([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters], [Custo_Joelho_SpeedTwo_Mean, Custo_Quadril_SpeedTwo_Mean, Custo_Umbigo_SpeedTwo_Mean, Custo_Xifoide_SpeedTwo_Mean], yerr=CI_Two, fmt='--', color='goldenrod', label="0.2", linewidth=2.0, )
ax.errorbar([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters], [Custo_Joelho_SpeedFour_Mean, Custo_Quadril_SpeedFour_Mean, Custo_Umbigo_SpeedFour_Mean, Custo_Xifoide_SpeedFour_Mean], yerr=CI_Four, fmt='-.', color='limegreen', label="0.4", linewidth=2.0)
ax.errorbar([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters], [Custo_Joelho_SpeedSix_Mean, Custo_Quadril_SpeedSix_Mean, Custo_Umbigo_SpeedSix_Mean, Custo_Xifoide_SpeedSix_Mean],yerr=CI_Six, fmt='--', color='mediumorchid', label="0.6", linewidth=2.0)
ax.errorbar([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters], [Custo_Joelho_SpeedEight_Mean, Custo_Quadril_SpeedEight_Mean, Custo_Umbigo_SpeedEight_Mean, Custo_Xifoide_SpeedEight_Mean],yerr=CI_Eight, fmt='--', color='dodgerblue', label="0.8", linewidth=2.0)
...
plt.legend(labels = line_labels, loc = 'best', title = 'Depth', fontsize=16)
...
host.set_xticks(np.arange(min(Data_Array_Profundidade_Meters[:,1]), max(Data_Array_Profundidade_Meters[:,1])+1, 0.2))
...
host.yaxis.set_ticks(np.arange(0,Cost_Two_ymax, 1))
par2.yaxis.set_ticks(np.arange(truncate(GRFV_MEAN_ymin,-2),GRFV_MEAN_ymax,200))

# Getting the Data to be Plotted
p1, = host.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters], [Custo_Joelho_SpeedTwo_Mean, Custo_Quadril_SpeedTwo_Mean, Custo_Umbigo_SpeedTwo_Mean, Custo_Xifoide_SpeedTwo_Mean],linestyle = '-' ,color='black', linewidth=3.0, label = 'Cost')
p2, = par1.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters],[Drag_F_Joelho_SpeedTwo_Mean, Drag_F_Quadril_SpeedTwo_Mean, Drag_F_Umbigo_SpeedTwo_Mean, Drag_F_Xifoide_SpeedTwo_Mean],linestyle = '--', color = 'silver',  linewidth=3.0, label = 'Drag')
p3, = par2.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters],[GRF_V_MEAN_Joelho_Mean, GRF_V_MEAN_Quadril_Mean, GRF_V_MEAN_Umbigo_Mean, GRF_V_MEAN_Xifoide_Mean], linestyle = ':', color = 'silver',  linewidth=3.0, label = 'GRFV_Mean')
host.legend(fontsize=16, frameon=False, loc='upper center')
...
host.yaxis.set_ticks(np.arange(0,Cost_Four_ymax, 2))
par2.yaxis.set_ticks(np.arange(truncate(GRFV_MEAN_ymin,-2),GRFV_MEAN_ymax,200))

# Getting the Data to be Plotted
p1, = host.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters], [Custo_Joelho_SpeedFour_Mean, Custo_Quadril_SpeedFour_Mean, Custo_Umbigo_SpeedFour_Mean, Custo_Xifoide_SpeedFour_Mean],linestyle = '-' ,color='black', linewidth=3.0, label = 'Cost')
p2, = par1.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters],[Drag_F_Joelho_SpeedFour_Mean, Drag_F_Quadril_SpeedFour_Mean, Drag_F_Umbigo_SpeedFour_Mean, Drag_F_Xifoide_SpeedFour_Mean],linestyle = '--', color = 'silver',  linewidth=3.0, label = 'Drag')
p3, = par2.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters],[GRF_V_MEAN_Joelho_Mean, GRF_V_MEAN_Quadril_Mean, GRF_V_MEAN_Umbigo_Mean, GRF_V_MEAN_Xifoide_Mean], linestyle = ':', color = 'silver',  linewidth=3.0, label = 'GRFV_Mean')
host.legend(fontsize=16, frameon=False, loc='upper center')
...
host.yaxis.set_ticks(np.arange(0,Cost_Six_ymax, 4))
par2.yaxis.set_ticks(np.arange(truncate(GRFV_MEAN_ymin,-2),GRFV_MEAN_ymax,200))

# Getting the Data to be Plotted
p1, = host.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters], [Custo_Joelho_SpeedSix_Mean, Custo_Quadril_SpeedSix_Mean, Custo_Umbigo_SpeedSix_Mean, Custo_Xifoide_SpeedSix_Mean],linestyle = '-' ,color='black', linewidth=3.0, label = 'Cost')
p2, = par1.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters],[Drag_F_Joelho_SpeedSix_Mean, Drag_F_Quadril_SpeedSix_Mean, Drag_F_Umbigo_SpeedSix_Mean, Drag_F_Xifoide_SpeedSix_Mean],linestyle = '--', color = 'silver',  linewidth=3.0, label = 'Drag')
p3, = par2.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters],[GRF_V_MEAN_Joelho_Mean, GRF_V_MEAN_Quadril_Mean, GRF_V_MEAN_Umbigo_Mean, GRF_V_MEAN_Xifoide_Mean], linestyle = ':', color = 'silver',  linewidth=3.0, label = 'GRFV_Mean')
host.legend(fontsize=16, frameon=False, loc='upper center')
...
host.set_ylim(0,Cost_Eight_ymax)
par1.set_ylim(Drag_F_Eight_ymin, Drag_F_Eight_ymax)
par2.set_ylim(GRFV_MEAN_ymin, GRFV_MEAN_ymax)

host.yaxis.set_ticks(np.arange(0,Cost_Eight_ymax, 4))
par2.yaxis.set_ticks(np.arange(truncate(GRFV_MEAN_ymin,-2),GRFV_MEAN_ymax,200))

# Getting the Data to be Plotted
p1, = host.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters], [Custo_Joelho_SpeedEight_Mean, Custo_Quadril_SpeedEight_Mean, Custo_Umbigo_SpeedEight_Mean, Custo_Xifoide_SpeedEight_Mean],linestyle = '-' ,color='black', linewidth=3.0, label = 'Cost')
p2, = par1.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters],[Drag_F_Joelho_SpeedEight_Mean, Drag_F_Quadril_SpeedEight_Mean, Drag_F_Umbigo_SpeedEight_Mean, Drag_F_Xifoide_SpeedEight_Mean],linestyle = '--', color = 'silver',  linewidth=3.0, label = 'Drag')
p3, = par2.plot([Depth_Joelho_Meters, Depth_Quadril_Meters, Depth_Umbigo_Meters, Depth_Xifoide_Meters],[GRF_V_MEAN_Joelho_Mean, GRF_V_MEAN_Quadril_Mean, GRF_V_MEAN_Umbigo_Mean, GRF_V_MEAN_Xifoide_Mean], linestyle = ':', color = 'silver',  linewidth=3.0, label = 'GRFV_Mean')
host.legend(fontsize=16, frameon=False, loc='upper center')
...
X = Custo_AllDepths_Mean_withSpeedColumn[:,0]   #Speed
Y = Custo_AllDepths_Mean_withSpeedColumn[:,1]   #Custo
...
Z_2,error_2,_,_,_ = np.polyfit(X, Y, 2, full=True)
f_2 = np.poly1d(Z_2)
Text_2 = ["%.2f" % x for x in Z_2]
Error_2 = ["%.2f" % x for x in error_2]
# calculate new x's and y's
X_2_new = np.linspace(X[0], X[-1], 50)
Y_2_new = f_2(X_2_new)

#Create figure
fig, ax = plt.subplots()
fig.canvas.set_window_title('Cost of Transport per Walking Speed POLYNOMIAL FIT')
ax.plot(X_2_new, Y_2_new, '--', color = 'black',linewidth = 2.5, label= 'Fit Line 2º Degree')
ax.plot(X_1_new, Y_1_new, '-', color = 'black',linewidth = 2.5, label= 'Fit Line 1º Degree')
ax.errorbar([0.2, 0.4, 0.6, 0.8], Custo_Joelho_All_Speed_Mean_list, yerr=Custo_Joelho_All_Speed_CI_list, fmt='s:', color='darkgray', linewidth=2.5, label = 'Knee')
ax.errorbar([0.2, 0.4, 0.6, 0.8], Custo_Quadril_All_Speed_Mean_list, yerr=Custo_Quadril_All_Speed_CI_list, fmt='o--', color='darkgray', linewidth=2.5, label= 'Hip')
ax.errorbar([0.2, 0.4, 0.6, 0.8], Custo_Umbigo_All_Speed_Mean_list, yerr=Custo_Umbigo_All_Speed_CI_list, fmt='d-.', color='darkgray', linewidth=2.5, label ='Umbilical')
ax.errorbar([0.2, 0.4, 0.6, 0.8], Custo_Xifoide_All_Speed_Mean_list, yerr=Custo_Xifoide_All_Speed_CI_list, fmt='^--', color='darkgray', linewidth=2.5,  label = 'Xiphoid')
ax.plot([0.2, 0.4, 0.6, 0.8], [Custo_Ardigo_Two, Custo_Ardigo_Four, Custo_Ardigo_Six, Custo_Ardigo_Eight], '-', color='slategrey', linewidth=3.0, label = 'Land (Ardigò 2003)')
#VAS_Joelho = VAS_Joelho*4/0.8
#VAS_Quadril = VAS_Quadril*4/0.8
#VAS_Umbigo = VAS_Umbigo*4/0.8
#VAS_Xifoide = VAS_Xifoide*4/0.8
...
plt.ylabel('Cost of Transport (J/kg/m)', fontsize=16)
ax.tick_params(labelsize=14)
#line_labels = ['Knee','Hip','Umbilical', 'Xiphoid']
...
ax.text(0.40, 12.7, 'Polynomial 1º parameters:', fontsize=14)
ax.text(0.57, 12.7, Text_1[0], fontsize=14)
ax.text(0.60, 12.7, 'X +', fontsize=14)
ax.text(0.63, 12.7, Text_1[1], fontsize=14)
ax.text(0.40, 11.8, 'Fit error 1º:', fontsize=14)
ax.text(0.48, 11.8, Error_1[0], fontsize=14)
...
# calculate new x's and y's
X_2_new_PotMet = np.linspace(X_PotMet[0], X_PotMet[-1], 50)
Y_2_new_PotMet = f_2_PotMet(X_2_new_PotMet)

#Create figure
fig, ax = plt.subplots()
fig.canvas.set_window_title('Metabolic Power Net per Walking Speed POLYNOMIAL FIT')
ax.plot(X_2_new_PotMet, Y_2_new_PotMet, '--', color = 'black',linewidth = 2.5, label= 'Fit Line 2º Degree')
ax.plot(X_1_new_PotMet, Y_1_new_PotMet, '-', color = 'black',linewidth = 2.5, label= 'Fit Line 1º Degree')
ax.errorbar([0.2, 0.4, 0.6, 0.8], PotMet_Joelho_All_Speed_Mean_list, yerr=PotMet_Joelho_All_Speed_CI_list, fmt='s:', color='darkgray', linewidth=2.5, label = 'Knee')
ax.errorbar([0.2, 0.4, 0.6, 0.8], PotMet_Quadril_All_Speed_Mean_list, yerr=PotMet_Quadril_All_Speed_CI_list, fmt='o--', color='darkgray', linewidth=2.5, label= 'Hip')
ax.errorbar([0.2, 0.4, 0.6, 0.8], PotMet_Umbigo_All_Speed_Mean_list, yerr=PotMet_Umbigo_All_Speed_CI_list, fmt='d-.', color='darkgray', linewidth=2.5, label ='Umbilical')
ax.errorbar([0.2, 0.4, 0.6, 0.8], PotMet_Xifoide_All_Speed_Mean_list, yerr=PotMet_Xifoide_All_Speed_CI_list, fmt='^--', color='darkgray', linewidth=2.5,  label = 'Xiphoid')
