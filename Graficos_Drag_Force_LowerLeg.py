...
File_Path_LL_Joelho = os.path.join("C:/Users/andre/Documents/Mestrado/Projetos Pesquisa/Projeto Marcha Água/Coletas/Data/Planilhas Gráficos Python/Curves_DragForce_Segments/Planilha_Curva_DragForce_LowerLeg_Joelho.txt")
Data_LL_Joelho = pd.read_csv(File_Path_LL_Joelho, delimiter="\t", header=0)
Data_LL_Joelho_Array = np.array(Data_LL_Joelho)

Joelho_Speed_2 = Data_LL_Joelho_Array[:, 0]
Joelho_Speed_4 = Data_LL_Joelho_Array[:, 1]
Joelho_Speed_6 = Data_LL_Joelho_Array[:, 2]
Joelho_Speed_8 = Data_LL_Joelho_Array[:, 3]
Joelho_Speed_VAS = Data_LL_Joelho_Array[:, 4]


#Open Hip Depth File
File_Path_LL_Quadril = os.path.join("C:/Users/andre/Documents/Mestrado/Projetos Pesquisa/Projeto Marcha Água/Coletas/Data/Planilhas Gráficos Python/Curves_DragForce_Segments/Planilha_Curva_DragForce_LowerLeg_Quadril.txt")
Data_LL_Quadril = pd.read_csv(File_Path_LL_Quadril,delimiter="\t",header = 0)
Data_LL_Quadril_Array = np.array(Data_LL_Quadril)

Quadril_Speed_2 = Data_LL_Quadril_Array[:, 0]
Quadril_Speed_4 = Data_LL_Quadril_Array[:, 1]
Quadril_Speed_6 = Data_LL_Quadril_Array[:, 2]
Quadril_Speed_8 = Data_LL_Quadril_Array[:, 3]
Quadril_Speed_VAS = Data_LL_Quadril_Array[:, 4]


#Open Umbilical Depth File
File_Path_LL_Umbigo = os.path.join("C:/Users/andre/Documents/Mestrado/Projetos Pesquisa/Projeto Marcha Água/Coletas/Data/Planilhas Gráficos Python/Curves_DragForce_Segments/Planilha_Curva_DragForce_LowerLeg_Umbigo.txt")
Data_LL_Umbigo = pd.read_csv(File_Path_LL_Umbigo,delimiter="\t",header = 0)
Data_LL_Umbigo_Array = np.array(Data_LL_Umbigo)

Umbigo_Speed_2 = Data_LL_Umbigo_Array[:,0]
Umbigo_Speed_4 = Data_LL_Umbigo_Array[:,1]
Umbigo_Speed_6 = Data_LL_Umbigo_Array[:,2]
Umbigo_Speed_8 = Data_LL_Umbigo_Array[:,3]
Umbigo_Speed_VAS = Data_LL_Umbigo_Array[:,4]


#Open Xiphoid Depth File
File_Path_LL_Xifoide = os.path.join("C:/Users/andre/Documents/Mestrado/Projetos Pesquisa/Projeto Marcha Água/Coletas/Data/Planilhas Gráficos Python/Curves_DragForce_Segments/Planilha_Curva_DragForce_LowerLeg_Xifoide.txt")
Data_LL_Xifoide = pd.read_csv(File_Path_LL_Xifoide,delimiter="\t",header = 0)
Data_LL_Xifoide_Array = np.array(Data_LL_Xifoide)

Xifoide_Speed_2 = Data_LL_Xifoide_Array[:,0]
Xifoide_Speed_4 = Data_LL_Xifoide_Array[:,1]
Xifoide_Speed_6 = Data_LL_Xifoide_Array[:,2]
Xifoide_Speed_8 = Data_LL_Xifoide_Array[:,3]
Xifoide_Speed_VAS = Data_LL_Xifoide_Array[:,4]
...
fig, ax = plt.subplots(2,2, sharex=True)        #Create figure with 4 subplots (2 row, 2 columns)
fig.canvas.set_window_title('Drag Force LOWER LEG')                 #Set Figure Window Title
fig.suptitle('Drag Force on LOWER LEG', fontsize = 14)              #Set Figure Main Title
